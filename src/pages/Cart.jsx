...
import {
  addPizzaToCart,
  clearCart,
  removeOnePizzaFromCart,
  removePizzaFromCart,
} from "../store/actions/CartActions";
import { pizzaType } from "../utitlitis";

export default function Cart() {
  let pizzas = useSelector((state) => state.items);
...
function CartItem({ id, imageUrl, name, type, size, quantity, price }) {
  let dispatch = useDispatch();
    ...
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <div
          ...
          onClick={() => {
            dispatch(removeOnePizzaFromCart(id));
          }}
        >
          <svg
            width="10"
